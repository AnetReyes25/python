# Una funcion resive parametros o variables para realizar una tarea especifica 
...
# Creamos una variable a con lo que diga ele usuario
a = input("Escriba un numero: ")

#Convertimos la variable a numero
a = int(a)

# Creamos una variable a con lo que dia ele usuario
